...
from tac2persian.utils.g2p.phonemizer_api import phonemize, separator, version, logger, punctuation
from tac2persian.utils.g2p.phonemizer_api.backend import (
